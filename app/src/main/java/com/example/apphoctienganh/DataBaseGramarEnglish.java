...
public class DataBaseGramarEnglish extends SQLiteOpenHelper {
    private static final String DB_NAME = "QuestionLanguageFixed";
    private static final String TABLE_NAME = "QuestionQuick";
    private static final String ID = "Id";
    private static final String QUESTION = "Question";
    private static final String ANSWER = "Answer";
    private static final String ALLCHOICE = "Choice";

    public DataBaseGramarEnglish(@Nullable Context context) {
